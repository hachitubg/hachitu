...
const GITHUB_ISSUES_URL = `${REPO_URL}/issues/new`
  ...
  <div v-if="error" class="min-h-screen bg-bg-deep flex items-center justify-center px-6">
    <div class="text-center max-w-md">
      ...
      <div class="mt-8 flex items-center justify-center gap-4">
        <button
          type="button"
          class="bg-accent-coral text-bg-surface font-display font-bold text-sm tracking-widest px-6 py-3 hover:bg-accent-amber transition-colors cursor-pointer"
          @click="retry"
        >
          THỬ LẠI
        </button>
