...
withDefaults(
  ...
  {
    searchPlaceholder: 'Tìm theo tên app...',
    ...
    <div class="flex flex-col sm:flex-row gap-3">
      <div class="relative flex-1">
        ...
        <input
          ...
          class="w-full bg-bg-surface border border-border-default pl-11 pr-12 py-3 text-sm text-text-primary placeholder:text-text-dim font-body transition-colors duration-200 focus:outline-none focus:border-accent-coral"
        />
        <kbd
    ...
    <div class="relative">
      ...
      >
        <button
          ...
          :class="
            category === null
              ? 'bg-accent-coral text-bg-surface border-accent-coral'
